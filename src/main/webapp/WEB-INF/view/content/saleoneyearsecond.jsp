...
<div
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-header"><h2 class="div-title">全年报名人数及产出</h2></div>
                                ...
                                <form class="layui-form">
                                    <ul id='filter-ul'>
                                        <li><input type="checkbox" value="subject_name"
                                                   title="课程科目" lay-skin="primary" lay-filter='filter' checked></li>
...
<script type="text/javascript" src="res/js/admin/saleoneyearsecond.js"></script>
</html>