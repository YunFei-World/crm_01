...
<div
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-header"><h2 class="div-title">月统计</h2></div>
        ...
        <div id='table'>
                        ...
                        <div class="map-tools">
                                    ...
                                    <form class="layui-form">
                                        <ul id='filter-ul'>
                                            ...
                                            <li><input type="checkbox" value="month"
                                                       title="统计月份" lay-skin="primary" lay-filter='filter' checked></li>
                            ...
                            <div class="layui-form" style="display: inline-block;">
                                <div class="layui-form-item layui-form-text"
                                    ...
                                    <label class="layui-form-label">选择统计</label>
                                    <div class="layui-input-inline" style="margin-top: 5px">
                                        <input type="text" class="layui-input" style="height: 30px" id="choice-month"
            ...
            <%--<div id='post-detailed-div' style="display: none;">
                ...
                <table class="layui-hide" id="post-detailed" lay-filter="post-detailed"></table>
            </div>--%>
...
<script type="text/javascript" src="res/js/admin/staffStatisticsMonth.js"></script>
</html>