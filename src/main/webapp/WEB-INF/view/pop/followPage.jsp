                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="next_time_up" id='next_time_up' class="layui-input"
                                       placeholder="yyyy-MM-dd HH:mm:ss" autocomplete="off" readonly="readonly" >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <div style="margin: 5px; float: left;">
                                    <div style="background-color: #fff; height: 200px; width: 200px; border-radius: 3px; border: 1px solid #b9b9b9; display: flex;"
                                            align="center">
...
<script>
    ...
    layui.use(['element', 'jquery', 'form', 'laydate','upload'], function () {
        ...
        form.on('submit(add-staff)', function (data) {
            ...
            $.ajax({
                type: "post",
                url: "addFollow?" + $("#add-form").serialize()
