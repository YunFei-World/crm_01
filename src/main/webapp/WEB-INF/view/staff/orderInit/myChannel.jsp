...
<div class="content layui-col-xs12 layui-col-sm12 layui-col-md12 layui-col-lg12">
    <div class="layui-card">
        ...
        <div class="layui-card-header"><h2 class="div-title">渠道列表</h2></div>
...
<script>
    layui.use(['table', 'jquery', 'form', 'element'], function () {
        ...
        var channelTable = table.render({
            elem: '#channel',
            url: 'channel/findMyChannel?staff_id=' + staff_id + "&campus_id=" + campusId,
            toolbar: '#toolBar',
            title: '职位表',
            cols: [[{
                title: '编号',
        ...
        function searchAdd(key) {
            ...
            table.reload('channel', {
                url: 'channel/findMyChannel?key=' + key + '&filter=' + Array.from(filter) + '&staff_id=' + staff_id + "&campus_id=" + campusId
            });
        }
