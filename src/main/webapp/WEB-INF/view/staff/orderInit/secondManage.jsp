        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test" id='menue-ul'>
                <li class="layui-nav-item ">
                    <a class="" href="javascript:;" id="myOrderinit" onclick="changeBodyOne('OrderinitFollow')">
                        <img alt="..." src="res/image/icon/organizational_structure.png" width="30" height="30">
                        毛单跟踪
                    </a>
                </li>
                <li class="layui-nav-item ">
                    <a class="" href="javascript:;" id="myMarketing" onclick="changeBodyOne('myOrderInitStatistics')">
                        <img alt="..." src="res/image/icon/organizational_structure.png" width="30" height="30">
                        我的统计
                    </a>
                </li>
