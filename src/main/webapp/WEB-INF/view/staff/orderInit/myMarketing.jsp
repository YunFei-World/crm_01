                                ...
                                <div id='filter-ul-div' class="filter-ul-div">
                                    <form class="layui-form">
                                        ...
                                        <ul id='filter-ul'>
                                            ...
                                            <li><input type="checkbox" value="marketing_fee"
                                                       title="活动费用" lay-skin="primary" lay-filter='filter' checked></li>
                    ...
                    <div id='addMarketing-content' style="display: none">
                        ...
                        <div class="layui-card-body">
                            <form class="layui-form" id='add-marketing-form' accept-charset="UTF-8">
                                    ...
                                    <div class="layui-form-item layui-form-text">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="marketing_fee" id="marketing_fee" required
                                                   lay-verify="required" placeholder="请输金额(注：如果不可包含字符！！)" autocomplete="off"
                                                   class="layui-input">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="option_remark" class="content layui-col-xs12 layui-col-sm12 layui-col-md12 layui-col-lg12">
                                    <fieldset class="layui-elem-field"  id>
                                        <legend>备用方案</legend>
                                            ...
                                            <div
                                                ...
                                                <div class="layui-form-item layui-form-text">
                                                    ...
                                                    <div class="layui-input-block">
                                                        ...
                                                        <div class="layui-upload-drag" id="option_first_all" name="option_first_all">
                                            ...
                                            <div
                                                ...
                                                <div class="layui-form-item layui-form-text">
                                                    ...
                                                    <div class="layui-input-block">
                                                        ...
                                                        <div class="layui-upload-drag" id="option_second_all" name="option_second_all">
                                                            <i class="layui-icon" ></i>
                                                            <p>点击上传，或将文件拖拽到此处</p>
                                                        </div>
...
<script type="text/javascript" src="res/js/admin/myMarketing.js"></script>
</body>
</html>