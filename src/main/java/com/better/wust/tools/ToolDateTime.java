...
public class ToolDateTime {
	...
	//private static //logger //log = //logger.get//logger(ToolDateTime.class);
     ...
     * @return
     */
    public static long compareStrDate(Date time1, Date time2) {
...
//		 System.out.print(ToolDateTime.getFirstDateOfMonth(new Date()));
	...
	//	 System.out.print(ToolDateTime.getDaySpaceDate(parse(bdate,pattern_ymd), parse(edate,pattern_ymd)));
		...
		System.out.println(addDate(3,30));
		System.out.println(getInternalDateByDay(dateFormat.parse(bdate),30));
	}
